#!/usr/bin/env python3
"""Generate self-contained HTML reports for aks-updater.
...
def build_plan(data: dict) -> str:
    ...
    return fill(template, {
        ...
        "RESOURCE_GROUP": esc(cluster.get("resource_group", "—")),
        "SUBSCRIPTION": esc(cluster.get("subscription", "—")),
...
# plan:
# {
#   "cluster":      {"name": str, "resource_group": str, "subscription": str, "k8s_version": str},
...
#                     "decision", "reason"}],
#       # source ∈ {"terraform", "addon", "extension", "helm"}
...
# summary:
# {
#   "cluster":          {"name", "resource_group", "subscription", "k8s_version"},
